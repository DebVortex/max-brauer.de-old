...
These are the default settings in :file:`max-brauer.de/manage.py`.
...
:py:class:`maxbrauer.config.settings.common.Common`.
...
.. list-table::
    ...
    * - ``STATIC_ROOT``
      - ``'<full path to maxbrauer>/static_root/'``
      - ``DJANGO_STATIC_ROOT``
...
:py:class:`maxbrauer.config.settings.databases.Databases`.

The following classes inherit from it:

* :py:class:`maxbrauer.config.settings.dev.Development`
* :py:class:`maxbrauer.config.settings.public.Production`
* :py:class:`maxbrauer.config.settings.public.Staging`
* :py:class:`maxbrauer.config.settings.test.Testing`
...
:py:class:`maxbrauer.config.settings.email.SMTP`
...
from :py:class:`maxbrauer.config.settings.email.Mailgun`
to use these settings.
...
from :py:class:`maxbrauer.config.settings.public.Raven`
to use these settings.
...
The class
:py:class:`maxbrauer.config.settings.public.Public`
...
from :py:class:`maxbrauer.config.settings.public.SSL`
to use these settings.
:py:class:`maxbrauer.config.settings.public.Production`
